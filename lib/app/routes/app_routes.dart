abstract class Routes {
  ...
  static const WEIGHT_UNIT_TYPE = '/weight-unit-type';
  ...
  static const ROLE_FORM = '/role-form';
  static const PERMISSION_MANAGEMENT = '/permission-management';
  
  // Gate entry routes
  static const GATE_ENTRY = '/gate-entry';
  static const GATE_ENTRY_FORM = '/gate-entry-form';
  static const GATE_PASS = '/gate-pass';
  
  // Weighbridge routes
  static const WEIGHBRIDGE = '/weighbridge';
  static const WEIGHBRIDGE_FORM = '/weighbridge-form';
  static const WEIGH_SLIP = '/weigh-slip';
  
  // Material loading routes
  static const MATERIAL_LOADING = '/material-loading';
  static const MATERIAL_LOADING_FORM = '/material-loading-form';
  
  // Billing routes
  static const BILLING = '/billing';
  static const INVOICE_FORM = '/invoice-form';
  static const INVOICE_VIEW = '/invoice-view';
  
  // Reports routes
  static const REPORTS = '/reports';
  static const DAILY_REPORT = '/daily-report';
  static const VEHICLE_REPORT = '/vehicle-report';
  static const MATERIAL_REPORT = '/material-report';
  static const BUYER_REPORT = '/buyer-report';
